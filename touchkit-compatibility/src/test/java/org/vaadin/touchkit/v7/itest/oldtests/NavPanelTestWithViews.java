...
public class NavPanelTestWithViews extends NavigationManager
  ...
  public NavPanelTestWithViews() {
    ...
    NavigationView testView = new NavigationView("TestView modal sub windows");
    ...
    Button.ClickListener listener = new Button.ClickListener() {
      ...
      public void buttonClick(ClickEvent event) {
         ...
         * topStuff.addComponent(header); topStuff.setExpandRatio(header, 1.0f);
         * 
         * topStuff.addComponent(new Button("Close", new Button.ClickListener()
         * {
         * 
        ...
        if (event.getButton() == fullScreen) {
          ...
          cssLayout.addComponent(
              new Label("Nothing here actually, close button on tab1."));
    ...
    final Button button = new Button("Try me (TouchKit's modal window impl)",
        listener);
  ...
  static class SimpleNavView extends NavigationView implements ClickListener {
    ...
    private void generateSubViews() {
      ...
      switch1 = new Switch();
      switch1.setCaption(
          "ios wannabe checkbox with very long caption that will easily be clipped");
      switch1.setIcon(getNextIcon());
      components.addComponent(switch1);

      Switch switch2 = new Switch();
      switch2.setCaption(
          "ios wannabe checkbox with so long caption that nobody is sure where it starts and where it ends. Caption's length is infinite, just like the universe.");
